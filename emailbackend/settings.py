...
ALLOWED_HOSTS = ['labufa.pythonanywhere.com']
...
TEMPLATES = [
    {
        ...
        'DIRS': ['/home/LaBufa/La-Bufa-Cats/templates/'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATIC_URL = '/static/'
STATIC_ROOT = '/home/LaBufa/La-Bufa-Cats/static/'

MEDIA_URL = '/media/'
MEDIA_ROOT = '/home/LaBufa/La-Bufa-Cats/media/'
